...
def page_2():
    st.title('This is the second page for my project which was assigned by Eng: Abdel Rahman')
    st.sidebar.title('Data Visualization for Heart Disease Dataset')
    st.sidebar.header('Data Visualization for Heart Disease Dataset')
    st.button('Click here to start')
    st.write('This is the second page for my project')

def page_3():
    st.title('This is the third page for my project which was assigned by Eng: Abdel Rahman')
    st.sidebar.title('Data Visualization for Heart Disease Dataset')
    st.sidebar.header('Data Visualization for Heart Disease Dataset')
    st.button('Click here to start')
    st.write('This is the third page for my project')

pages = {'main page': main_page, 'sec_page': page_2, 'thir_page': page_3}
